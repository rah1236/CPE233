...
REM
REM Generated by Vivado on Mon Sep 26 00:24:07 -0700 2022
...
echo "xvlog --incr --relax -prj exp1_ckt_wrapper_vlog.prj"
call xvlog  --incr --relax -prj exp1_ckt_wrapper_vlog.prj -log xvlog.log
